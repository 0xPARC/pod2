...
impl Operation {
    ...
    op_impl_oa!(sum_of, SumFromEntries, 3);
    op_impl_oa!(product_of, ProductFromEntries, 3);
    op_impl_oa!(max_of, MaxFromEntries, 3);
    op_impl_oa!(hash_of, HashFromEntries, 3);
    ...
    op_impl_oa!(public_key_of, PublicKeyFromEntries, 2);
