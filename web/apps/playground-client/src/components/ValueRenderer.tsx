...
import type { Value, Dictionary, Set as PodSet, RawValue } from '../types/pod2'; // Adjusted Set import
...
const ValueRenderer: React.FC<ValueRendererProps> = ({ value }) => {
  ...
  if (typeof value === 'object') {
    ...
    if ('Set' in value) {
      ...
      if (set.length === 0) return <span className="font-mono text-orange-600 dark:text-orange-400">Set([])</span>;
      return (
