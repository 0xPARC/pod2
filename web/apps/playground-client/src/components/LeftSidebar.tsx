...
export function LeftSidebar({ toggleExplorer, isExplorerCollapsed, explorerContent }: { toggleExplorer: () => void, isExplorerCollapsed: boolean, explorerContent: React.ReactNode }) {
  return (
    <>
      {/* Left Explorer Panel */}
      {!isExplorerCollapsed && (
