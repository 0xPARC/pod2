...
export const podlogMonarchLanguage = {
  ...
  keywords: [
    'REQUEST', 'AND', 'OR', // 'true', 'false', // Handled by specific literal rules now
    'ValueOf', 'Equal', 'NotEqual', 'Gt', 'GtEq', 'Lt', 'LtEq',
    'Contains', 'NotContains', 'SumOf', 'ProductOf', 'MaxOf', 'HashOf',
    'DictContains', 'DictNotContains', 'ArrayContains', 'SetContains', 'SetNotContains'
  ...
  tokenizer: {
    root: [
      ...
      // String Literals
      [/"/, { token: 'string.quoted.double.podlog', bracket: '@open', next: '@string_double' }],
      [/'/, { token: 'string.quoted.single.podlog', bracket: '@open', next: '@string_single' }],
    ...
    string_double: [ // Renamed from 'string'
      [/[^\\\\"]+/, 'string.quoted.double.podlog'],
      [/@escapes/, 'string.escape.char.podlog'],
      [/\\\\./, 'string.escape.invalid.podlog'],
      [/"/, { token: 'string.quoted.double.podlog', bracket: '@close', next: '@pop' }]
    ],

    string_single: [ // Added for single-quoted strings
      [/[^\\\\']+/, 'string.quoted.single.podlog'],
      [/@escapes/, 'string.escape.char.podlog'],
      [/\\\\./, 'string.escape.invalid.podlog'],
      [/'/, { token: 'string.quoted.single.podlog', bracket: '@close', next: '@pop' }]
    ],
